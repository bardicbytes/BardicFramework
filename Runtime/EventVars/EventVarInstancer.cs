...
namespace BardicBytes.BardicFramework.EventVars
{
    public class EventVarInstancer : ActorModule
    {
        ...
        [SerializeField]
        [SerializeReference]
        private EVInstData[] eventVarInstances;
        ...
        protected override void OnValidate()
        {
            ...
            if (refreshEvCache && eventVars != null && eventVars.Count > 0)
            {
                ...
                eventVarInstances = new EVInstData[eventVars.Count];
            ...
            EVInstData Restorebackup(EventVar src, EVInstData[] instBackup, int[] cacheBackup)
            {
        ...
        public EVInstData FindInstanceData(EventVar ev)
        {
            EVInstData e = null;
            for (int i = 0; i < eventVarInstances.Length; i++)
            {
