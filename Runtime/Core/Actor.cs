...
namespace BardicBytes.BardicFramework.Core
{
    public class Actor : MonoBehaviour
    {
        ...
        ///// <returns>the asset's value if there is no actor instance</returns>
        //public OutT GetActorValue<InT, OutT>(EvaluatingEventVar<InT,OutT> eventVarAssetRef)
        //{
        //    Debug.Assert(eventVarAssetRef.HasValue);
        //    if (!HasActorInstance(eventVarAssetRef)) return eventVarAssetRef.Value;
        //    return GetActorInstance(eventVarAssetRef).Value;
        //}

        //public InT GetStoredActorValue<InT>(EventVar eventVarAssetRef)
        //{
        //    Debug.Assert(eventVarAssetRef.HasValue);
        //    if (HasActorInstance(eventVarAssetRef)) return (InT)eventVarAssetRef.UntypedStoredValue;
        //    return (InT)eventVarAssetRef.UntypedStoredValue;
        //}
